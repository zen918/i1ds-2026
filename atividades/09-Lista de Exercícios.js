...
console.log("se a altura do retangulo é", altura, "e o comprimento é de", comprimento, "a area é =", area )
console.log("---------------------------------------------------------------------------------------------")
...
var imc = peso / (altura * altura)
 console.log("uma pessoa que mede", altura, "e pesa", peso,"kg tem o imc =", imc)
console.log("-------------------------------------------------------------------------")
...
console.log ("a media final do aluno que tirou as notas", nota, nota2, nota3, "é de =", media)
console.log("---------------------------------------------------------------------------------")
